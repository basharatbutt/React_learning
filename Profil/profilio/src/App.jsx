...
function App() {
  ...
  return (
    ...
    {/* Permanent Premium Dark Background */}
    <div className="min-h-screen bg-[#0B1121] text-slate-200 overflow-hidden font-sans">
      ...
      <main className="max-w-7xl mx-auto px-6 md:px-12 lg:px-16 relative z-10 pt-28">
        ...
        {/* =========================================
            1. HERO SECTION 
            ========================================= */}
        <section id="home" className="w-full py-16 lg:py-20 flex flex-col lg:flex-row items-center justify-between gap-16 scroll-mt-28 border-b border-slate-800/80"> 
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left space-y-6">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-[1.1] text-white">
              ...
              {/* FIXED: Removed gradient text so Chrome Extensions don't hide it! */}
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-6 pt-4">
              <button 
                ...
                className="w-full sm:w-auto bg-cyan-500 hover:bg-cyan-400 text-[#0B1121] font-bold text-base px-8 py-3.5 rounded-full transition-all hover:-translate-y-1"
              >
                Hire Me
              </button>
          ...
          <div className="w-full lg:w-1/2 flex justify-center lg:justify-end mt-10 lg:mt-0">
            <div className="relative w-64 sm:w-80 md:w-96 lg:w-[420px]">
              <img
                ...
                className="relative z-10 w-full rounded-3xl border-2 border-slate-700 object-cover"
              />
            </div>
          </div>
        </section>
        ...
        {/* =========================================
            2. ABOUT ME SECTION 
            ========================================= */}
        <section id="about" className="w-full py-20 scroll-mt-28 border-b border-slate-800/80">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-extrabold text-white">
              About <span className="text-cyan-400">Me</span>
            </h2>
            <div className="w-20 h-1 mt-4 mx-auto rounded-full bg-cyan-500"></div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-start">
            ...
            <div className="w-full lg:w-1/2 space-y-8">
              ...
              {/* FIXED: Used Solid colors for boxes so extensions don't ruin them */}
              <div className="bg-[#131C31] border border-slate-700 p-6 rounded-2xl space-y-4">
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 shrink-0 rounded-full bg-[#1E293B] flex items-center justify-center text-sm text-cyan-400 border border-slate-600">✉</div>
            ...
            <div className="w-full lg:w-1/2 space-y-8">
              <div className="grid grid-cols-2 gap-4 md:gap-6">
                <div className="bg-[#131C31] border border-slate-700 p-6 md:p-8 rounded-2xl text-center hover:border-cyan-500/50 transition-all duration-300">
                  {/* FIXED: Solid color text-cyan-400 instead of gradient */}
                  <h4 className="text-4xl md:text-5xl font-black text-cyan-400 mb-2">4+</h4>
                  <p className="text-slate-400 font-medium text-sm">Months Experience</p>
                </div>
                <div className="bg-[#131C31] border border-slate-700 p-6 md:p-8 rounded-2xl text-center hover:border-cyan-500/50 transition-all duration-300">
                  {/* FIXED: Solid color text-cyan-400 instead of gradient */}
                  <h4 className="text-4xl md:text-5xl font-black text-cyan-400 mb-2">10+</h4>
                  <p className="text-slate-400 font-medium text-sm">Projects Completed</p>
                </div>
              </div>

              <div className="bg-[#131C31] border border-slate-700 p-6 md:p-8 rounded-2xl">
                ...
                <div className="flex flex-wrap justify-center lg:justify-start gap-3">
                  {['HTML5', 'CSS3', 'JavaScript', 'React.js', 'Node.js', 'Express.js', 'Tailwind', 'Git', 'MongoDB'].map((skill) => (
                    <span key={skill} className="px-4 py-2 bg-[#1E293B] text-slate-300 text-sm font-medium rounded-lg border border-slate-600 hover:border-cyan-400 hover:text-cyan-400 transition-all cursor-default">
                      {skill}
                    </span>
                  ))}
                </div>
        ...
        {/* =========================================
            3. SERVICES SECTION
            ========================================= */}
        <section id="services" className="w-full py-20 scroll-mt-28 border-b border-slate-800/80">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-extrabold text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {[
              ...
              <div key={index} className="bg-[#131C31] border border-slate-700 p-8 rounded-2xl hover:-translate-y-2 hover:border-cyan-400 transition-all duration-300 group">
                <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-6 bg-[#1E293B] border border-slate-600 group-hover:bg-cyan-500/20 transition-colors">
        ...
        <section id="contact" className="w-full max-w-3xl mx-auto py-20 scroll-mt-28">
          ...
          <form className="bg-[#131C31] border border-slate-700 p-6 md:p-10 rounded-3xl space-y-6">
            <div className="flex flex-col md:flex-row gap-6">
              <div className="w-full">
                <label className="block text-slate-300 font-medium mb-2 text-sm">Your Name</label>
                <input type="text" placeholder="John Doe" className="w-full bg-[#0B1121] border border-slate-600 text-white px-4 py-3.5 rounded-xl outline-none focus:border-cyan-400 transition-colors placeholder:text-slate-500" />
              </div>
              <div className="w-full">
                <label className="block text-slate-300 font-medium mb-2 text-sm">Your Email</label>
                <input type="email" placeholder="john@example.com" className="w-full bg-[#0B1121] border border-slate-600 text-white px-4 py-3.5 rounded-xl outline-none focus:border-cyan-400 transition-colors placeholder:text-slate-500" />
              </div>
            </div>
            
            <div>
              <label className="block text-slate-300 font-medium mb-2 text-sm">Your Message</label>
              <textarea rows="5" placeholder="How can I help you?" className="w-full bg-[#0B1121] border border-slate-600 text-white px-4 py-3.5 rounded-xl outline-none focus:border-cyan-400 transition-colors resize-none placeholder:text-slate-500"></textarea>
            </div>

            <button type="button" className="w-full bg-cyan-500 hover:bg-cyan-400 text-[#0B1121] font-bold text-lg px-8 py-4 rounded-xl transition-all hover:-translate-y-1">
              Send Message
            </button>
          </form>
        </section>
